      ...
      <div className="container-wide">
        ...
        <div className="flex flex-wrap items-center justify-center gap-6 md:gap-10 lg:gap-14">
          {(logos ?? []).map((logo) => {
            ...
            // dc_import writes both /placeholder/ and /ai-generated/ paths.
            const imageUrl = logo.image?.url ?? ''
            const isAutoGenerated = imageUrl.includes('placeholder') || imageUrl.includes('ai-generated')
            const hasValidImage = imageUrl.startsWith('http') && !isAutoGenerated
